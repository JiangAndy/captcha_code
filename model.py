...
class ResNet(nn.Module):
    ...
    def save(self, save_path):
        ...
        name = os.path.join(save_path, 'resnet_best.pth')
        t.save(self.state_dict(), name)

    def loadIfExist(self, save_path):
        fileList = os.listdir(save_path)
        # print(fileList)
        if "resnet_best.pth" in fileList:
            name = os.path.join(save_path, 'resnet_best.pth')
            self.load_state_dict(t.load(name))
            print("the best resnet model has been load")
...
class CaptchaNet(nn.Module):
    ...
    def save(self, save_path):
        print('saving best model')
        name = os.path.join(save_path, 'net_best.pth')
        t.save(self.state_dict(), name)

    def loadIfExist(self, save_path):
        fileList = os.listdir(save_path)
        # print(fileList)
        if "net_best.pth" in fileList:
            name = os.path.join(save_path, 'net_best.pth')
            self.load_state_dict(t.load(name))
            print("the best net model has been load")
...
class Res18(nn.Module):
    ...
    def save(self, save_path):
        print('saving best model')
        name = os.path.join(save_path, 'res18_best.pth')
        t.save(self.state_dict(), name)

    def loadIfExist(self, save_path):
        fileList = os.listdir(save_path)
        # print(fileList)
        if "res18_best.pth" in fileList:
            name = os.path.join(save_path, 'res18_best.pth')
            self.load_state_dict(t.load(name))
            print("the best res18 model has been load")